...
class GalleryViewModel @Inject constructor(
    ...
    fun monthlyVideo(done:(Uri?,String?)->Unit){viewModelScope.launch{runCatching{exporter.monthlyVideo(selfies.value)}.onSuccess{done(it,null)}.onFailure{done(null,it.message)}}}
